    ...
    return (<>
        <div className="justify-center items-center flex overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none bg-neutral-800/70">
            <div className="relative w-full md:w-4/6 lg:w-3/6 xl:w-2/5 my-6 mx-auto h-full lg:h-auto md:h-auto">
                ...
                ${showModal ? 'opacity-y-100' : 'opacity-0'}
                `} >
                    <div className="translate h-full border-0 rounded-lg shadow-lg relative w-full bg-white outline-none md:h-auto lg:h-auto focus:outline-none">
                        {/* HEADER */}
                        <div className="flex flex-col items-center p-6 rounded-t justify-center relative border-b-[1px]">
                            <button
                                onClick={handleClose}
                                className="p-1 border-0 hover:opacity-70 transition absolute left-9 top-6">
                                <IoMdClose size={18} />
                            </button>
